  ...
  <!-- Charts Section -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-lg shadow">
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="relative">
                                    <select class="appearance-none bg-white border border-gray-300 rounded-md pl-3 pr-8 py-1 text-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500">
                            ...
                            <div class="h-64">
                                <svg class="w-full h-full" viewBox="0 0 800 240" xmlns="http://www.w3.org/2000/svg">
                                    <!-- Grid lines -->
                                    <line x1="50" y1="210" x2="750" y2="210" stroke="#e5e7eb" stroke-width="1" />
                                    <line x1="50" y1="170" x2="750" y2="170" stroke="#e5e7eb" stroke-width="1" />
                                    <line x1="50" y1="130" x2="750" y2="130" stroke="#e5e7eb" stroke-width="1" />
                                    <line x1="50" y1="90" x2="750" y2="90" stroke="#e5e7eb" stroke-width="1" />
                                    <line x1="50" y1="50" x2="750" y2="50" stroke="#e5e7eb" stroke-width="1" />
                                    
                                    <!-- Y-axis labels -->
                                    <text x="40" y="210" text-anchor="end" font-size="12" fill="#6b7280">0</text>
                                    <text x="40" y="170" text-anchor="end" font-size="12" fill="#6b7280">250k</text>
                                    <text x="40" y="130" text-anchor="end" font-size="12" fill="#6b7280">500k</text>
                                    <text x="40" y="90" text-anchor="end" font-size="12" fill="#6b7280">750k</text>
                                    <text x="40" y="50" text-anchor="end" font-size="12" fill="#6b7280">1M</text>
                                    
                                    <!-- X-axis labels (months) -->
                                    <text x="80" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Jan</text>
                                    <text x="150" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Fév</text>
                                    <text x="220" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Mar</text>
                                    <text x="290" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Avr</text>
                                    <text x="360" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Mai</text>
                                    <text x="430" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Juin</text>
                                    <text x="500" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Juil</text>
                                    <text x="570" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Aoû</text>
                                    <text x="640" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Sep</text>
                                    <text x="710" y="225" text-anchor="middle" font-size="12" fill="#6b7280">Oct</text>
                                    
                                    <!-- Revenue area -->
                                    <path d="M80,170 L150,150 L220,130 L290,110 L360,90 L430,70 L500,90 L570,110 L640,130 L710,150 L710,210 L80,210 Z" 
                                          fill="rgba(34, 197, 94, 0.1)" />
                                    
                                    <!-- Revenue line -->
                                    <path d="M80,170 L150,150 L220,130 L290,110 L360,90 L430,70 L500,90 L570,110 L640,130 L710,150" 
                                          fill="none" stroke="#22c55e" stroke-width="2" />
                                    
                                    <!-- Revenue points -->
                                    <circle cx="80" cy="170" r="4" fill="#22c55e" />
                                    <circle cx="150" cy="150" r="4" fill="#22c55e" />
                                    <circle cx="220" cy="130" r="4" fill="#22c55e" />
                                    <circle cx="290" cy="110" r="4" fill="#22c55e" />
                                    <circle cx="360" cy="90" r="4" fill="#22c55e" />
                                    <circle cx="430" cy="70" r="4" fill="#22c55e" />
                                    <circle cx="500" cy="90" r="4" fill="#22c55e" />
                                    <circle cx="570" cy="110" r="4" fill="#22c55e" />
                                    <circle cx="640" cy="130" r="4" fill="#22c55e" />
                                    <circle cx="710" cy="150" r="4" fill="#22c55e" />
                                </svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow">
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-medium text-gray-900">Distribution par type</h3>
                                <div class="relative">
                                    <select class="appearance-none bg-white border border-gray-300 rounded-md pl-3 pr-8 py-1 text-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Voitures</span>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Motos</span>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Tricycles</span>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Nyonyovi</span>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Minibus</span>
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Bus</span>
                                        <span class="text-sm font-medium text-gray-700">1%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-indigo-500 h-2 rounded-full" style="width: 1%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-sm font-medium text-gray-700">Camions</span>
                                        <span class="text-sm font-medium text-gray-700">1%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2">
